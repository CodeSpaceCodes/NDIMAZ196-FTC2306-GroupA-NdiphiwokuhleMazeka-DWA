 ...
 * @return {void} 
 */
export const findRemainingBooks = (event) => {
    const { library: {
        books: { },
        BOOKS_PER_PAGE: { }
    }
 ...
 * @returns {void}
 */
 export function searchSubmit(event) {
 ...
 * @param {*} event 
*/
 export const saveSettings = (event) => {
    event.preventDefault();
...
export const closeReviewBook = (event) => {
 ...
 * @returns {void}
 */
export const showSearchOverlay = (event) => {
 ...
 * @param {} event 
 */
export const closeSearchOverlay = (event) => {
    props.search.dataSearchOverlay.close();
};
 ...
 * @returns {void}
*/
export const showSettingsOverlay = (event) => {
 ...
 * @returns {void}
*/
export const closeSettingsOverlay = (event) => {
    props.settings.dataSettingsOverlay.close();
};
